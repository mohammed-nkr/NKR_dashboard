...
public class MaleDonationDashboard {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		radio1.click();
		driver.findElement(By.xpath("//input[@name = 'BirthDate']")).sendKeys("3/7/1970");
		...
		driver.findElement(By.xpath("//button[@class='btn btn-primary btn-lg']")).click();	//continue
		Thread.sleep(5000);
		WebElement rad3 = driver.findElement(By.xpath("//input[@name = 'HasIntendedRecipient' and @value = 'False']"));	//donatio details
		rad3.click();
		
		driver.findElement(By.xpath("//button[@class = 'btn btn-primary btn-lg']")).click();	//Continue
		Thread.sleep(5000);
		
		driver.findElement(By.xpath("//button[contains(text(),'Done')]")).click();	//continue
		Thread.sleep(5000);
