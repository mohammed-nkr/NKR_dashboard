...
public class DonorRegistration1A {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		driver.findElement(By.xpath("//input[@name = 'FirstName']")).sendKeys("Ahoat");
		driver.findElement(By.id("LastName")).sendKeys("nmvb");
		driver.findElement(By.name("Email")).sendKeys("uit@kidneyregistry.org");
		...
		driver.findElement(By.xpath("//input[@id='phoneNumber']")).sendKeys("34723443249");
		driver.findElement(By.xpath("//input[@id='PostalCode']")).sendKeys("11412");
		
		WebElement radio1 = driver.findElement(By.xpath("//input[@name='Gender' and @value='Male']"));
		radio1.click();
		//System.out.println(radio1.isSelected());
		driver.findElement(By.xpath("//input[@name = 'BirthDate']")).sendKeys("10/7/1972");
		...
		rad0.click();
		//System.out.println(rad2.isSelected());
		...
		driver.findElement(By.xpath("")).sendKeys("3475401230");	//Emergency Contact Number
		...
		Thread.sleep(5000);
		//I'm almost done
		driver.findElement(By.xpath("//button[@class='btn btn-primary btn-lg']")).click();//I'm 
		Thread.sleep(5);
		driver.findElement(By.xpath("//a[@class='btn btn-success dash-step-btn']")).click();//Pre-Workup Labs_End
		//Pre-Workup Labs_End
