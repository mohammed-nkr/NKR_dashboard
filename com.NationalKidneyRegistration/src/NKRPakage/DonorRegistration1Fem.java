...
public class DonorRegistration1Fem {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		driver.findElement(By.xpath("//input[@name = 'FirstName']")).sendKeys("pwe");
		driver.findElement(By.id("LastName")).sendKeys("lkj");
		driver.findElement(By.name("Email")).sendKeys("pba@kidneyregistry.org");
		...
		//driver.manage().window().maximize();
		driver.findElement(By.xpath("//a[contains(text(),'Continue')]")).click();//doesn't work (ONLY CODE THROUGHOOUT THE ENTIRE SCRIPT)
		Thread.sleep(1000);
		//Test Case_3: Screening Summary
		driver.findElement(By.xpath("//input[@id='phoneNumber']")).sendKeys("9298996365");
		...
		driver.findElement(By.xpath("//input[@id = 'WeightLbs']")).sendKeys("https://nkr.donorscreen.fail/register/continue/226764/87C87A1DEFBFFD27");
		...
		driver.findElement(By.xpath("//input[@name = 'AddressLine1' ]")).sendKeys("203-15 112 av.");
		driver.findElement(By.xpath("//input[@name = 'City']")).sendKeys("Saint Albans");
		...
		select7.deselectByVisibleText("3");
		driver.findElement(By.xpath("//input[@id = 'EmergencyContact']")).sendKeys("Haka"); //Emergency Contact Name
		driver.findElement(By.xpath("")).sendKeys("3475678786");	//Emergency Contact Number
		...
		WebElement radbtn5 = driver.findElement(By.xpath("//input[@name='HasHadPhysicalExam' and @value='No']"));//Physicalexam
		radbtn5.click();
		WebElement radbtn6 = driver.findElement(By.xpath("//input[@id='HasHadMammogram' and @value='No']"));//mammogram
		radbtn6.click();
		WebElement radbtn7 = driver.findElement(By.xpath("//input[@id='HasHadPapSmear' and @value='No']"));//Pap smear
		radbtn7.click();
		WebElement radbtn8 = driver.findElement(By.xpath("//input[@id='HasHadPsaTest' and @value='No']"));//PSA Test
		radbtn8.click();
		...
		rbutn5.click();
		driver.findElement(By.xpath("//label[normalize-space()='Yes']//input[@id='IsMotherAlive']")).sendKeys("65");
		driver.findElement(By.xpath("//label[normalize-space()='Yes']//input[@id='IsFatherAlive']")).sendKeys("70");
		...
		//driver.findElement(By.xpath("/html/body/main/div/div/div/div/div[2]/div[1]/div[2]/div[3]/a")).click();
